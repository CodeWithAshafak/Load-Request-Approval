...
import { Filter, Eye, Download, FileText, ArrowLeft, X } from 'lucide-react'
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              <div className="grid grid-cols-2 gap-6 mb-6">
                ...
                {selectedRequest.expectedDeliveryDate && (
                  <div>
                    <p className="text-sm font-medium text-gray-500 mb-1">Expected Delivery</p>
                    <p className="text-base text-gray-900">
                      {new Date(selectedRequest.expectedDeliveryDate).toLocaleDateString('en-US', { 
                        year: 'numeric', 
                        month: 'long', 
                        day: 'numeric' 
                      })}
